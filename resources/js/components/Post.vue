    ...
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        <div class="flex flex-col p-4">
            <div class="flex items-center">
                <div class="w-8">
                    <img :src="profileImage" alt="profile image for user"
...
export default {
    ...
    computed: {
        ...
        profileImage() {
            const path = '../../../';
            const profileImage = path + 'uploads/' + this.post.user.profile_image;
            const defaultImage = path + 'default.jpg';

            return this.post.user.profile_image ? profileImage : defaultImage;
        },
        reacts_count() {
            return +this.post.like_count + +this.post.love_count + +this.post.haha_count +
                +this.post.sad_count + this.post.wow_count + +this.post.angry_count;
        }
    },
    methods: {}
}
