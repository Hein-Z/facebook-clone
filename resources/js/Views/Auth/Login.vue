            ...
            <form class="shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="submit">
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        type="password" placeholder="******************" v-model="user.password" id="password">
                ...
                <div class="mt-2 flex justify-center">Do not have account?
                    <router-link :to="{name:'register'}" class="font-bold ml-2 text-blue-500 hover:text-blue-800">
                        Register
                    </router-link>
                </div>
            </form>
    ...
    methods: {
        ...
        submit() {
            this.login(this.user).then(res => {
                ...
                if (error.data.correct_credential && !error.data.email_verified) {
